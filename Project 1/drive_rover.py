...
class RoverState():
    def __init__(self):
        ...
        self.rock_angles = 0 # Angle to available rock pixels
        self.rock_dists = 0 # Distances of available rock pixels
        self.obs_angles = None # Angles of obstacles pixels
        self.obs_dists = None # Distances of obstacles pixels
        self.picked_rock = False
        self.rock_in_the_middle = False
        self.near = False
